...
try {
    ...
    if ($conn->query($createDbQuery)) {
        $statusMessages[] = [
            'type' => 'success',
            'text' => "Database `$db_name` created successfully or already exists."
        ];
    } else {
    ...
    if ($conn->query($createUsersTable)) {
        $statusMessages[] = [
            'type' => 'success',
            'text' => 'Table `users` created successfully.'
        ];
    } else {
    ...
    if ($conn->query($createDevicesTable)) {
        $statusMessages[] = [
            'type' => 'success',
            'text' => 'Table `devices` created successfully.'
        ];
    } else {
    ...
    if ($conn->query($createBookingsTable)) {
        $statusMessages[] = [
            'type' => 'success',
            'text' => 'Table `bookings` created successfully.'
        ];
    } else {
    ...
    if ($conn->query($createPaymentsTable)) {
        $statusMessages[] = [
            'type' => 'success',
            'text' => 'Table `payments` created successfully.'
        ];
    } else {
    ...
    if ($conn->query($createReviewsTable)) {
        $statusMessages[] = [
            'type' => 'success',
            'text' => 'Table `reviews` created successfully.'
        ];
    } else {
    ...
    if ($conn->query($createTournamentsTable)) {
        $statusMessages[] = [
            'type' => 'success',
            'text' => 'Table `tournaments` created successfully.'
        ];
    } else {
        throw new Exception("Error creating tournaments table: " . $conn->error);
    }
    ...
    if ($conn->query($createParticipantsTable)) {
        $statusMessages[] = [
            'type' => 'success',
            'text' => 'Table `participants` created successfully.'
        ];
    } else {
        throw new Exception("Error creating participants table: " . $conn->error);
    }
    ...
    if ($conn->query($createNotificationsTable)) {
        $statusMessages[] = [
            'type' => 'success',
            'text' => 'Table `notifications` created successfully.'
        ];
    } else {
    ...
    if ($conn->query($createPromotionsTable)) {
        $statusMessages[] = [
            'type' => 'success',
            'text' => 'Table `promotions` created successfully.'
        ];
    } else {
        throw new Exception("Error creating promotions table: " . $conn->error);
    }
    ...
    if ($conn->query($createSettingsTable)) {
        $statusMessages[] = [
            'type' => 'success',
            'text' => 'Table `settings` created successfully.'
        ];
    } else {
    ...
    if ($conn->query($createInvoiceDetailsTable)) {
        $statusMessages[] = [
            'type' => 'success',
            'text' => 'Table `invoice_details` created successfully.'
        ];
    } else {
        throw new Exception("Error creating invoice_details table: " . $conn->error);
    }
    ...
    if ($userCount == 0) {
        ...
        if ($conn->query($insertUsers)) {
            $statusMessages[] = [
                'type' => 'success',
                'text' => 'Sample users inserted successfully.'
            ];
        }
    }
    ...
    if ($deviceCount == 0) {
        ...
        if ($conn->query($insertDevices)) {
            $statusMessages[] = [
                'type' => 'success',
                'text' => 'Sample devices inserted successfully.'
            ];
        }
    }
    ...
    if ($settingCount == 0) {
        ...
        if ($conn->query($insertSettings)) {
            $statusMessages[] = [
                'type' => 'success',
                'text' => 'System settings initialized successfully.'
            ];
        }
    }
    ...
    $statusMessages[] = [
        'type' => 'danger',
        'text' => 'Setup failed: ' . $e->getMessage()
    ];
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>GameZone Database Setup</title>
                ...
                <div class="card shadow-sm">
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            <i class="bi bi-database-fill-gear display-1 text-primary"></i>
                            <h1 class="h3 mt-3">GameZone Database Setup</h1>
                            <p class="text-muted">Initialize database tables and sample data</p>
                        </div>
                        ...
                        <?php if (!$error): ?>
                            <div class="alert alert-info mt-4">
                                <h5 class="alert-heading"><i class="bi bi-info-circle me-2"></i>Default Login Credentials</h5>
                                <hr>
                                <p class="mb-2"><strong>Admin:</strong> admin@gamezone.com / admin123</p>
                                <p class="mb-2"><strong>Customer:</strong> customer@email.com / customer123</p>
                                <p class="mb-0"><strong>Staff:</strong> staff@gamezone.com / staff123</p>
                            </div>
